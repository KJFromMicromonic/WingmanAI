...
export default function PracticeInterviewsPage() {
    ...
    try {
      ...
      const tokenResponse = await fetch('/api/voice/interview-token', {
        ...
        body: JSON.stringify({
          ...
          participantName: `candidate-${user?.id}`,
          metadata: {
  ...
  if (!isUserLoaded || isUserDataLoading) {
    return <div className="min-h-screen bg-slate-900 text-white flex items-center justify-center">Loading user data...</div>;
  }
    ...
    return (
      <div className="min-h-screen bg-slate-900 text-white flex flex-col items-center justify-center text-center p-8">
        ...
        <p className="text-slate-400 mb-6 max-w-md">
          Practice Interviews are available only to premium users. Upgrade your plan to access this feature and ace your next interview.
        </p>
        <Link href="/settings/billing">
          <Button className="bg-purple-600 hover:bg-purple-700">View Premium Plans</Button>
        </Link>
      </div>
    );
  }
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-slate-900 text-white flex flex-col items-center justify-center text-center p-8">
        ...
        <p className="text-slate-400 mb-6 max-w-md">
          Please sign in to access the practice interview feature.
        </p>
        <Link href="/sign-in">
  ...
  if (interviewState.status === 'setup') {
    return (
      <div
        className="min-h-screen bg-gradient-to-br from-slate-900 to-purple-900 p-6 flex items-center justify-center"
      >
        <div
      ...
      >
        {interviewState.selectedPersona && (
          <div className="text-center mb-6">
            ...
            <p className="text-slate-400 text-sm">
              {INTERVIEW_PERSONAS[interviewState.selectedPersona].title} at {INTERVIEW_PERSONAS[interviewState.selectedPersona].company}
            </p>
        ...
        <div className="flex-1 p-6 overflow-y-auto grid grid-cols-3 gap-6">
          ...
          <div className="col-span-3 lg:col-span-2 flex flex-col">
            <div className="flex-1 bg-slate-900/50 rounded-lg p-4 space-y-4 overflow-y-auto h-[400px]">
            ...
            >
              ...
              {interviewState.status === 'completed' && (
                <>
                  ...
                  <Button onClick={() => router.push('/dashboard')} className="mt-4 bg-purple-600 hover:bg-purple-700">
                    Close
                  </Button>
                </>
              )}
