-- Supabase migration for WingMan AI user profiles (CLERK COMPATIBLE)
-- This version works with Clerk authentication where user IDs are strings
...
-- For Clerk integration, we don't use Supabase RLS since Clerk handles auth
-- Instead, we'll handle security at the application level
-- If you want to enable RLS later, you can uncomment these lines:
...
COMMENT ON TABLE users IS 'Enhanced user profiles with comprehensive tracking for Clerk authentication';
...
-- Example of how to insert a test scenario (uncomment if needed)
/*
INSERT INTO scenarios (id, title, description, setting, category, difficulty, is_premium, persona_id, image, context) VALUES
('cafe-1', 'Coffee Shop Conversation', 'Practice casual conversation in a relaxed coffee shop environment', 'Coffee Shop', 'social', 'beginner', false, 'emma', '/images/cafe.jpg', 'You are in a cozy coffee shop on a weekend afternoon...');
*/
